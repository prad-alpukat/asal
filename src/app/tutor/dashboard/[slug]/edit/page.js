...
export default function EditContent() {
    ...
    const breadcrumb = [
        ...
        { name: "Edit Konten", link: "/tutor/dashboard/" + slug + "/edit" },
    ]
        ...
        <main>
            <div className="container py-10">
                ...
                <Card className="max-w-md mx-auto mt-8">
                    <CardHeader>
                        <CardTitle>Edit Konten Kelas {slug}</CardTitle>
                    </CardHeader>
                    <CardContent >
                        <form onSubmit={handleSubmit}>
                            <div className="grid w-full items-center gap-4">
                                ...
                                <div className="flex flex-col space-y-1.5">
                                    ...
                                    <Input required id="title" type="text" placeholder="Pengenalan Kalkulus" value={defaultValues.title} />
                                </div>
                                <div className="flex flex-col space-y-1.5">
                                    <Label htmlFor="description">Deskripsi</Label>
                                    <Textarea required id="description" value={defaultValues.description} placeholder="Tulis deskripsi konten anda" />
                                </div>
                                <Button type="submit">Edit Konten Kelas</Button>
                            </div>
                        </form>
                    </CardContent>
                </Card>
